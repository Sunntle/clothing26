...
function loadItem() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function loadDataItem() {
            ...
            ${data.img
                .map((el, index) => (imgString = `<p><span style="width:200px">${el}</span>: <img class="img-fluid bg-transparent px-3"  style="max-width: 100px" src="../asset/img/${el}"><button type="button" class="btn-close" id="btnClose" data-value="${index}" aria-label="Close"></button></p>`))
                .join("")}
            </p> 
            <div class="mb-3">
